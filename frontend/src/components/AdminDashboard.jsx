...
const AdminDashboard = () => {
  ...
  const fetchColleges = async () => {
    try {
      const response = await axios.get('https://data-gathering-project.onrender.com/api/admin/colleges');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://data-gathering-project.onrender.com/api/admin/create-college', formData);
  ...
  const handleDeleteConfirm = async () => {
    ...
    setDeleting(true);
    try {
      await axios.delete(`https://data-gathering-project.onrender.com/api/admin/delete-college/${collegeToDelete._id}`);
